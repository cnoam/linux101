...
(content partially taken from course 095219/07_linux_tools)
...
This means that by using file permissions, we can recursively give access to a directory to a specific user/group.
...
1. as root, Create a sub directory `child` with permissions `0777`<br>
Can you (a regular user) list the files in child? <br>
