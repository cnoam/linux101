...
# locate a command
When we type a command (for example `date`), the shell looks for a file with that name and if found, execute it.<br>
How can we find where in the vast dir tree is this command?
...
### 💻 Exercise - how many lines in that file?
